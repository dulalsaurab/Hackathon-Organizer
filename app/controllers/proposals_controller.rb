...
=begin
    def upvote
        ...
        @proposals.like += 1
        @proposals.save
        redirect_to proposals_url, notice: "Thank you for voting!"
    end
=end
    ...
    Proposal.new(userId: 1, title: 'first proposal', hkId: 1, description: 'hello world', customForm: 'form', votes: 0)
    def create
